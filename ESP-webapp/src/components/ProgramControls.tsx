    ...
    <div className="col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
      ...
      <div className="flex flex-col rounded bg-gray-50 p-4 dark:bg-gray-800">
        ...
        <div className="flex flex-col gap-1">
          <label className="text-sm text-gray-500 dark:text-gray-400 font-medium">Payload Size (bytes)</label>
          <div className="flex items-center gap-2">
            ...
            <input
              type="number"
              className="w-24 rounded border border-gray-300 bg-white p-1 text-sm dark:bg-gray-700 dark:text-white disabled:opacity-50 focus:outline-none"
              value={bwPayloadSize}
